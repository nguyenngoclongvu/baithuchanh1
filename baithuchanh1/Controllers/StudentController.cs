...
namespace baithuchanh1.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDStudent,NameStudent,PhoneStudent,AddStudent")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IDStudent,NameStudent,PhoneStudent,AddStudent")] Student student)
        {
